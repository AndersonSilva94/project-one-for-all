...
# Projeto One for All  :superhero: PLUS ULTRA!

### Vigésimo projeto do curso de Desenvolvimento Full Stack Web da Trybe.
...
1. Clone o repositório
  * `git clone git@github.com:AndersonSilva94/project-one-for-all.git`.
...
3. Você pode verificar a lógica criada para o desafio 1 através dos arquivos `SpotifyClone-Non-NormalizedTable.xlsx` e `projeto_one_for_all`. Para este último é necessário acessar a página [draw.io](https://draw.io/) e selecionar o botão `Open Existing Diagram`, escolhendo o arquivo referido.

# Como foi desenvolvido

**Para cada desafio, um arquivo SQL foi criado com sua solução nele.**
